...
- (void)viewDidLoad {
  ...
  if (collections == nil) {
    ...
    //    decButton.frame = CGRectMake(0, 302 - (-2*44)+20, 320, 44);
    decButton.frame = CGRectMake(0, 302 - (0*44)+20, 320, 150);    
//    [decButton setTitle:element.name forState:UIControlStateNormal];
    ...
    for (element in collections) {
      ...
      button.frame = CGRectMake(0, 302 - (j*44)+20, 320, 44);
      if (j==-1) {
        button.frame = CGRectMake(0, 302 - (j*44)+21, 320, 44);
        UIImage *buttonImage = [UIImage imageNamed:@"theCarnabyButton.png"];
        [button setImage:buttonImage forState:UIControlStateNormal];        
      }else if(j==0){
        UIImage *buttonImage = [UIImage imageNamed:@"YanziButton.png"];
        [button setImage:buttonImage forState:UIControlStateNormal];          
      }
      ...
      fackButton.frame = CGRectMake(265.0, 302 - (j*44)+27, 29.0, 31.0);
      //if (j==-1) {
      //  fackButton.frame = CGRectMake(265.0, 302 - (j*44)+27, 29.0, 31.0);
      //}
...
//      [collectionUrl release];
    ...
    divButton.frame = CGRectMake(0, 302+44+20, 320, 1); 
//    divButton.backgroundColor = [UIColor colorWithRed:227 green:219 blue:206 alpha:0.8];
    ...
    [divButton setImage:listDividerImage forState:UIControlStateNormal];
    ...
    decoration.frame = CGRectMake(0, 302-(j-1)*44-108, 320, 128);
