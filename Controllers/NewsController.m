...
//  [button0 setTitle:@"test" forState:UIControlStateNormal]; 
//  button0.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.7];
//  [button0 addTarget:@"http://thecarnaby.koocaa.com/published_news.iphone" action:@selector(openURLFromButton:) forControlEvents:UIControlEventTouchUpInside];
//  [self.view addSubview: button0];
  ...
  if ([current_lang rangeOfString:@"zh-Han"].location != NSNotFound) {
    [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://thecarnaby.koocaa.com/published_news.iphone?lang=zh"]]];    
  }else{
    [self.webView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://thecarnaby.koocaa.com/published_news.iphone"]]];    
  }
}
